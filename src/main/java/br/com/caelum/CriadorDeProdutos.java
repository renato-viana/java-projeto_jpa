	...
	public void init() {
		...
		template.execute(new TransactionCallbackWithoutResult() {
			...
			protected void doInTransactionWithoutResult(TransactionStatus status) {
				...
				livroDeArquitetura.setNome("Introdução à arquitetura e design de software");
				...
				livroDeArquitetura.setDescricao("Neste livro, os autores, conhecidos especialistas da "
											   + " Area, apresentam muitos tópicos que aparecem com frequência"
											   + " na plataforma Java, incluindo desde modelagem e design das "
											   + "classes, estão detalhes importantes das tecnologias mais utilizadas."
